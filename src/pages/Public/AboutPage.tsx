        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
              Democratizar o acesso à moda urbana de qualidade, conectando
              pessoas com produtos que expressam sua personalidade e estilo de
              vida único.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Selecionamos cuidadosamente cada produto, garantindo materiais
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Trabalhamos com as melhores marcas para trazer as últimas
                tendências da moda urbana.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Constantemente atualizando nosso catálogo com produtos
                inovadores e exclusivos.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Acreditamos em relações claras e honestas com nossos
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Fazemos o que amamos e amamos o que fazemos. A moda é
                      nossa paixão e isso se reflete em tudo.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Comprometidos com a satisfação total de nossos clientes e
